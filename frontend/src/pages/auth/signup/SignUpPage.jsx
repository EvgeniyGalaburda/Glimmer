...
export default function SignUpPage() {
  ...
  return (
    <div className="max-w-screen-xl mx-auto flex h-screen px-10 ">
      ...
      <div className="flex-1 flex flex-col justify-center items-center animate-fade-left">
        <form className="lg:w-2/3 mx-auto md:mx-20 flex gap-4 flex-col" onSubmit={handleSubmit}>
        <img src={glimmer} className="w-24 lg:hidden rounded-full" alt="" />
        <h1 className="text-4xl font-extrabold text-white">Connect your light with millions!</h1>
